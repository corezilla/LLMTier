...
| LT-CAP-004 | queue expiry 与 dispatch authorization shall 原子竞争；Running timeout shall 保持 backend fact 与 Seat hold，直到有 terminal/cancel/reconcile 释放证据 | CT-DEADLINE-001 | Amendment 6 fixture PASS；runtime BLOCKED |
...
| LT-REL-003 | 无既有 Invocation 的 request 在 caller deadline 后 shall 不得首次 admission；deadline/decision expiry shall 不删除原 key/digest binding | CT-DEADLINE-001/CT-ADM-001 | Amendment 6 fixture PASS；runtime BLOCKED |
...
| LT-OPS-004 | capacity shall 发布 next-seat 逐约束事实而非 Project 需求；cost shall 以 decimal/currency/pricing source/version 和 Known/Estimated/Partial/Unknown 表达且不自动换汇 | CT-COST-001 | Amendment 6 fixture PASS；Slinky/runtime BLOCKED |
