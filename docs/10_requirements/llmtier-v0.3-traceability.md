...
基线是 requirements `0.3.2-draft.4`、system design `0.3.2-draft.4`、OpenAPI `0.3-simplified-candidate.5` 与 compatibility manifest 同版本。
...
| Admin UI/API | LT-FUN-005、LT-INT-008、LT-SEC-001/003 | §11.2、Web UI design §§3/8 | `/tier/admin/v1/*` | CT-ADMIN-001/CT-UI-001/CT-WEBSEC-001 | DESIGN COVERED；runtime BLOCKED |
