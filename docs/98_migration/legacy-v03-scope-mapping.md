...
| §6 Slinky Capacity/Observation | `llmtier-slinky-capacity-observation-control` / `docs/60_interfaces/slinky-capacity-observation-control.md` | OpenAPI and v0.3 capacity fixtures | canonical consumer boundary moves | none, subject to auditable Slinky verdict before promotion |
...
拟处置：全部有效 scope 均有 successor，旧文件可整体 Superseded；§6 只有在 Slinky auditable verdict 为
ACCEPTED 后才能执行。若 verdict 为 AMENDMENT，则 §6 residual 保留，整份旧文件不能整体 Supersede。
...
| Old scope | Successor Document ID / path | Retained machine or execution authority | Disposition | Residual |
|---|---|---|---|---|
| §1 authority/unique path | `llmtier-piko-data-plane-control` | compatibility manifest | canonical prose moves | none, subject to Piko ACCEPTED evidence |
...
拟处置：Piko verdict 为 ACCEPTED 且 authority uniqueness 检查通过后整体 Superseded；否则保留对应 residual。
...
| Old scope | Successor Document ID / path | Retained machine or execution authority | Disposition | Residual |
|---|---|---|---|---|
| §1 authority/unique inference path | `llmtier-slinky-capacity-observation-control` | compatibility manifest | canonical prose moves | none, subject to Slinky ACCEPTED evidence |
...
拟处置：Slinky verdict 为 ACCEPTED 且 authority uniqueness 检查通过后整体 Superseded；否则保留对应 residual。
...
拟处置：全部正式 prose scope 已映射，可整体 Superseded；未实现 UI 是 successor 中的 Open Gate，不是旧文档 residual。
...
| Old scope | Successor Document ID / path | Retained machine or execution authority | Disposition | Residual |
|---|---|---|---|---|
| §1 Slinky amendment traceability | `llmtier-v0.3-traceability`; C1/C2 review packets | Matrix verdict IDs and Git commits | traceability moves; message IDs retained as evidence | none, subject to auditable Slinky verdict |
...
| §3 Piko review traceability | `llmtier-v0.3-traceability`; C1/C2 review packets | Matrix verdict IDs and Git commits | traceability moves; message IDs retained as evidence | none, subject to auditable Piko verdict |
...
拟处置：两方 consumer verdict 可审计、Owner verdict 完成且 uniqueness 检查通过后整体 Superseded；否则保留
§1/§3 residual，整份旧 QA 不整体 Supersede。

## 6. 单一 current authority 检查

Promotion candidate 必须机器检查：
...
5. Piko/Slinky verdict 任一非 ACCEPTED 时，相关 residual 不得标为 none，旧文件不得整体 Supersede；
