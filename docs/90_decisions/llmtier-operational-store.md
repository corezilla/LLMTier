...
| 文档字段 | 值 |
|---|---|
| Document ID | `llmtier-operational-store` |
...
| Canonical Path | `docs/90_decisions/llmtier-operational-store.md` |
...
- Verification：`docs/70_verification/plans/llmtier-vv-plan.md`；
